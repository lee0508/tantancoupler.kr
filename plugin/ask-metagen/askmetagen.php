...
if ($bo_table && $wr_id) {
    ...
    //URL
    $_url = ask_short_url_clean($_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['SCRIPT_NAME'] . "?bo_table={$bo_table}&wr_id={$wr_id}");
    //첨부파일
    ...
    //게시판 목록
    $_url = ask_short_url_clean($_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['SCRIPT_NAME'] . "?bo_table={$bo_table}");
    $tags->link('canonical', $_url);
    ...
    //내용관리
    $_url = ask_short_url_clean($_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['SCRIPT_NAME'] . "?co_id={$co_id}");
    $tags->link('canonical', $_url);
